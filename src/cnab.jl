# TODO: split this file across three folders:
#   - init/         : CNAB struct, CNAB() constructor, initial_sol(), coupler types and constructors
#                     (AbstractCoupler, NothingCoupler, PrescribedBodyCoupler, FsiCoupler,
#                      CNAB_Binv_Precomputed, CNAB_Binv_Iterative, B_inverse_rigid, zero_vorticity!, set_time!)
#   - time-stepping/: step!, _step!, prediction_step!, coupling_step!, projection_step!,
#                     apply_vorticity!, update_reg!, _A_factor, Ainv, B_rigid_mul!, B_deform_mul!, ab_coeffs
#   - post-proc/    : save, load!, CNAB_signature, surface_force!, surface_force_sum
