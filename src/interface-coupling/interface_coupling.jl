# TODO: Reg must be defined before CNAB (which uses R<:Reg as a type parameter), but
# _f_tilde_factor/f_to_f_tilde!/redist!/update_redist_weights! require CNAB to be defined.
# This creates a circular include-order dependency that needs to be resolved — options are:
# (a) relax R<:Reg constraint in CNAB to unconstrained R, or
# (b) split this file into two and include them at different points in Immersa.jl.
